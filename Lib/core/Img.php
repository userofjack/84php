...
class Img
{
    ...
    public static function change($UnionData=[])
    {
        ...
        if (!empty($Word)) {
            ...
            $TextColor=imagecolorallocate($NewImg,$WordColorArray['red'],$WordColorArray['green'],$WordColorArray['blue']);
            if (!imagettftext($NewImg,$WordSize,0,$WordMarginX,$WordMarginY,$TextColor,Common::diskPath($_SERVER['84PHP']['Config']['Img']['fontFile']),$Word)) {
